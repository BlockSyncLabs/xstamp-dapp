...
const Login = () => {
  ...
  return (
    <div className="w-[600px] mt-[7.25rem]">
      ...
      <form className="mt-6">
        ...
        <div className="text-center mt-9">
          <button
            type="submit"
            className="uppercase rounded-lg bg-[#36d693] font-semibold w-[16.0625rem] text-black p-3"
          >
            Log In
          </button>
        </div>
      ...
      <div className="flex flex-col justify-center items-center mt-3">
        <div className="flex gap-1">
          ...
          <Link href="/auth/signup" className="font-medium text-[#2cd1b4]">Sign up</Link>
        </div>
      </div>
    </div>
  );
